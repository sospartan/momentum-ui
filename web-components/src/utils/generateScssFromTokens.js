...
`;
  ...
  const themeStyles = ["lmLight", "mdLight", "lmDark", "mdDark"];
  const themeStyleFiles = {
    lmLight: `${autoGeneratedMessage}@import "../../colors/settings.scss";\n`,
    mdLight: `${autoGeneratedMessage}@import "../../colors/settings.scss";\n`,
    lmDark: `${autoGeneratedMessage}@import "../../colors/settings.scss";\n`,
    mdDark: `${autoGeneratedMessage}@import "../../colors/settings.scss";\n`
  };
  ...
  for (const lightDarkTheme of lightDarkThemes) {
    for (const designTheme of designThemes) {
      ...
      ] += `@import "../../colors/vars/css-color-variables.scss";\n`;

      themeStyleFiles[
        `${designTheme}${lightDarkTheme}`
      ] += `@import "../../colors/vars/semantic-color-settings.scss";\n`;

      themeStyleFiles[
        `${designTheme}${lightDarkTheme}`
      ] += `@import "../../colors/vars/semantic-colors--${lowercaseLightDarkTheme}.scss";\n`;

      themeStyleFiles[
        `${designTheme}${lightDarkTheme}`
      ] += `@import "../../themes/global--${lowercaseLightDarkTheme}.scss";\n`;

      themeStyleFiles[`${designTheme}${lightDarkTheme}`] += `@import "../../themes/global--${designTheme}.scss";\n`;
